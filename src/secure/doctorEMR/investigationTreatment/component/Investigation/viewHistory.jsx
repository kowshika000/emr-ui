...
function ViewHistory({ handleViewHistoryModalClose, investigationAdded, setupdatedInvestigation }) {
    ...
    const handleAddInvestigation = (params) => {
        setupdatedInvestigation((prev) => [...prev, params.row]);
    }
                ...
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body" style={{ height: 400 }}>
                            <DataGrid rows={investigationAdded} columns={columns} pageSize={5} />
                        </div>
